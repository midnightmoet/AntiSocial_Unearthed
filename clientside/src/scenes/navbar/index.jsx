...
const Navbar = () => {
  ...
  const fullName = `${user.firstName} ${user.lastName}`; //used to display user's full name, this is a convience variable
...
// --------------------------------------------------------
// Notes:
// clamp is a css function that allows you to set a min, preferred and max value for a property
// sx is a prop that allows you to add custom styles to a component


// COMPLETED THE NAVBAR COMPONENT 11/09/2023